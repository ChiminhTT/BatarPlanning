...
var author$project$DispoTable$Model$UserData = function (a) {
	return {$: 'UserData', a: a};
};
var author$project$DispoTable$User$User = F3(
	function (id, name, weekDispo) {
		return {id: id, name: name, weekDispo: weekDispo};
	});
var author$project$DispoTable$User$WeekDisponibility = F7(
	function (monday, tuesday, wednesday, thursday, friday, saturday, sunday) {
...
var author$project$Main$weekDispoDecoder = A8(
	elm$json$Json$Decode$map7,
	author$project$DispoTable$User$WeekDisponibility,
	A2(elm$json$Json$Decode$field, 'monday', elm$json$Json$Decode$bool),
	A2(elm$json$Json$Decode$field, 'tuesday', elm$json$Json$Decode$bool),
	A2(elm$json$Json$Decode$field, 'wednesday', elm$json$Json$Decode$bool),
	A2(elm$json$Json$Decode$field, 'thursday', elm$json$Json$Decode$bool),
	A2(elm$json$Json$Decode$field, 'friday', elm$json$Json$Decode$bool),
	A2(elm$json$Json$Decode$field, 'saturday', elm$json$Json$Decode$bool),
	A2(elm$json$Json$Decode$field, 'sunday', elm$json$Json$Decode$bool));
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$map3 = _Json_map3;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$userDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$DispoTable$User$User,
	A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	author$project$Main$weekDispoDecoder);
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Main$decodeList = elm$json$Json$Decode$list(author$project$Main$userDecoder);
...
var author$project$Main$decoder = A2(
	...
	_List_fromArray(
		['data']),
	author$project$Main$decodeList);
...
var author$project$Main$initialCmd = A2(
	elm$http$Http$send,
	author$project$DispoTable$Model$UserData,
	A2(elm$http$Http$get, 'http://localhost:4000/api/users', author$project$Main$decoder));
var author$project$Main$initialModel = {users: _List_Nil};
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(author$project$Main$initialModel, author$project$Main$initialCmd);
};
var author$project$DispoTable$Model$UpdateUser = function (a) {
	return {$: 'UpdateUser', a: a};
};
var author$project$Main$server_api_url = 'http://localhost:4000/api/';
...
var author$project$Main$userEncoder = F3(
	function (user, newDispo, day) {
		var dayKey = function () {
			switch (day.$) {
				case 'Monday':
					return 'monday';
		...
		var userJson = elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					dayKey,
					elm$json$Json$Encode$bool(newDispo))
				]));
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2('user', userJson)
				]));
	});
...
var author$project$Main$updatePostRequest = F3(
	function (user, newDispo, day) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$jsonBody(
					A3(author$project$Main$userEncoder, user, newDispo, day)),
				expect: elm$http$Http$expectJson(
					A2(
						elm$json$Json$Decode$at,
						_List_fromArray(
							['data']),
						author$project$Main$userDecoder)),
				headers: _List_Nil,
				method: 'PATCH',
				timeout: elm$core$Maybe$Nothing,
				url: author$project$Main$server_api_url + ('users/' + elm$core$String$fromInt(user.id)),
				withCredentials: false
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UpdateDisponibility':
				...
				var request = A2(
					elm$http$Http$send,
					author$project$DispoTable$Model$UpdateUser,
					A3(author$project$Main$updatePostRequest, user, newDispo, day));
				return _Utils_Tuple2(
					model,
			...
			default:
				if (msg.a.$ === 'Ok') {
					var updatedUser = msg.a.a;
					var updateUsers = function (user) {
						return _Utils_eq(user.id, updatedUser.id) ? _Utils_update(
							user,
							{weekDispo: updatedUser.weekDispo}) : user;
					};
					var updatedUsers = A2(elm$core$List$map, updateUsers, model.users);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{users: updatedUsers}),
...
var author$project$DispoTable$Model$Friday = {$: 'Friday'};
var author$project$DispoTable$Model$Monday = {$: 'Monday'};
var author$project$DispoTable$Model$Saturday = {$: 'Saturday'};
var author$project$DispoTable$Model$Sunday = {$: 'Sunday'};
var author$project$DispoTable$Model$Thursday = {$: 'Thursday'};
var author$project$DispoTable$Model$Tuesday = {$: 'Tuesday'};
var author$project$DispoTable$Model$UpdateDisponibility = F3(
	function (a, b, c) {
		return {$: 'UpdateDisponibility', a: a, b: b, c: c};
	});
var author$project$DispoTable$Model$Wednesday = {$: 'Wednesday'};
...
var author$project$Main$getDisponibilityClass = function (dispo) {
	if (!dispo) {
		return elm$html$Html$Attributes$class('table-light');
	} else {
		return elm$html$Html$Attributes$class('bg-success');
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$getDisponibilityClass(user.weekDispo.monday),
						elm$html$Html$Events$onClick(
						A3(author$project$DispoTable$Model$UpdateDisponibility, user, !user.weekDispo.monday, author$project$DispoTable$Model$Monday))
					]),
				_List_Nil),
				A2(
				elm$html$Html$td,
				_List_fromArray(
					[
						author$project$Main$getDisponibilityClass(user.weekDispo.tuesday),
						elm$html$Html$Events$onClick(
						A3(author$project$DispoTable$Model$UpdateDisponibility, user, !user.weekDispo.tuesday, author$project$DispoTable$Model$Tuesday))
					]),
				_List_Nil),
				A2(
				elm$html$Html$td,
				_List_fromArray(
					[
						author$project$Main$getDisponibilityClass(user.weekDispo.wednesday),
						elm$html$Html$Events$onClick(
						A3(author$project$DispoTable$Model$UpdateDisponibility, user, !user.weekDispo.wednesday, author$project$DispoTable$Model$Wednesday))
					]),
				_List_Nil),
				A2(
				elm$html$Html$td,
				_List_fromArray(
					[
						author$project$Main$getDisponibilityClass(user.weekDispo.thursday),
						elm$html$Html$Events$onClick(
						A3(author$project$DispoTable$Model$UpdateDisponibility, user, !user.weekDispo.thursday, author$project$DispoTable$Model$Thursday))
					]),
				_List_Nil),
				A2(
				elm$html$Html$td,
				_List_fromArray(
					[
						author$project$Main$getDisponibilityClass(user.weekDispo.friday),
						elm$html$Html$Events$onClick(
						A3(author$project$DispoTable$Model$UpdateDisponibility, user, !user.weekDispo.friday, author$project$DispoTable$Model$Friday))
					]),
				_List_Nil),
				A2(
				elm$html$Html$td,
				_List_fromArray(
					[
						author$project$Main$getDisponibilityClass(user.weekDispo.saturday),
						elm$html$Html$Events$onClick(
						A3(author$project$DispoTable$Model$UpdateDisponibility, user, !user.weekDispo.saturday, author$project$DispoTable$Model$Saturday))
					]),
				_List_Nil),
				A2(
				elm$html$Html$td,
				_List_fromArray(
					[
						author$project$Main$getDisponibilityClass(user.weekDispo.sunday),
						elm$html$Html$Events$onClick(
						A3(author$project$DispoTable$Model$UpdateDisponibility, user, !user.weekDispo.sunday, author$project$DispoTable$Model$Sunday))
					]),
				_List_Nil)
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$int)({"versions":{"elm":"0.19.0"},"types":{"message":"DispoTable.Model.Msg","aliases":{"DispoTable.User.User":{"args":[],"type":"{ id : Basics.Int, name : String.String, weekDispo : DispoTable.User.WeekDisponibility }"},"DispoTable.User.WeekDisponibility":{"args":[],"type":"{ monday : Basics.Bool, tuesday : Basics.Bool, wednesday : Basics.Bool, thursday : Basics.Bool, friday : Basics.Bool, saturday : Basics.Bool, sunday : Basics.Bool }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"DispoTable.Model.Msg":{"args":[],"tags":{"UserData":["Result.Result Http.Error (List.List DispoTable.User.User)"],"UpdateDisponibility":["DispoTable.User.User","Basics.Bool","DispoTable.Model.Day"],"UpdateUser":["Result.Result Http.Error DispoTable.User.User"]}},"DispoTable.Model.Day":{"args":[],"tags":{"Monday":[],"Tuesday":[],"Wednesday":[],"Thursday":[],"Friday":[],"Saturday":[],"Sunday":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));